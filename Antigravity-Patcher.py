...
(function() {
  const dictionary = {
    ...
    "History": "历史记录", "Settings": "设置", "System": "系统", "Network": "网络", "Pinned Conversations": "置顶对话",
    ...
    "Awaiting Authentication...": "等待身份验证...", "Awaiting Authentication…": "等待身份验证…",
    "Use business account": "使用企业帐户", "Having trouble? Let us know": "遇到问题？请告诉我们",
    ...
    "Continue with different account": "使用其他帐户继续", "FAQ": "常见问题",
    ...
    "Project + Worktree": "项目 + 工作区树", "Outside of Project": "项目外", "Outside of project": "项目外",
    "Filter": "筛选", "Scheduled": "已计划", "Unread": "未读", "Only Unread": "仅未读", "Archived": "已归档", "Environment": "环境", "None": "无", "Fast": "快速",
    ...
    "Go Back": "返回", "Go Back Alt+←": "返回 Alt+←", "Go Forward": "前进", "Go Forward Alt+→": "前进 Alt+→",
    ...
    "Export": "导出", "Import": "导入", "Pin": "置顶", "Unpin": "取消置顶", "Archive": "归档", "Restore": "恢复", "Undo": "撤销",
    "Conversation Archived": "对话已归档", "This chat is archived.": "此对话已归档。",
    "View archived conversations in history.": "在历史记录中查看已归档的对话。",
    "View archived conversations in": "在以下位置查看已归档的对话：", "history": "历史记录",
    ...
    "+ New Conversation": "+ 新建对话", "New Conversation": "新建对话", "New Conversation in Project": "在项目中新建对话", "Conversation History": "历史对话", "Scheduled Tasks": "计划任务",
    ...
    "New Project": "新建项目", "No Project": "无项目", "No Project found": "暂无项目",
    "No Projects found": "暂无项目", "Quick Start": "快速开始",
    ...
    "Configures how the agent tries to access files outside of its working folders.": "配置智能体如何访问其工作文件夹之外的文件。",
    ...
    "Useful for tasks that require file access across your full machine. The agent has full read and write access to all local files, but all proposed terminal commands require manual review and approval before running.": "适用于需要访问整台计算机文件的任务。智能体对所有本地文件拥有完整的读写权限，但所有拟执行的终端命令在运行前都需要手动审阅和批准。",
    "Turbo mode": "极速模式",
    "Disables all safety barriers for maximal iteration velocity.": "禁用所有安全屏障，以获得最快的迭代速度。",
    "A high-risk mode that disables all safety barriers. The agent operates with full system access, auto-executes all terminal commands, and reads or writes to all local files without review prompts.": "一种禁用所有安全屏障的高风险模式。智能体拥有完整的系统访问权限，会自动执行所有终端命令，并可在没有审阅提示的情况下读写所有本地文件。",
    ...
    "Model Quota": "模型配额",
    "Refresh quota and credits data": "刷新配额与积分数据", "Refresh MCP servers": "刷新 MCP 服务器",
  ...
  function translateText(text) {
    ...
    text = text.replace(/Welcome to Antigravity/g, '欢迎使用 Antigravity');
    text = text.replace(/Sorry, this account is ineligible to use Antigravity/g, '抱歉，此帐户无法使用 Antigravity');
